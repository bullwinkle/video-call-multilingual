export const STUN_SERVERS_LIST: RTCIceServer[] = [
...
export const TURN_SERVERS_LIST: RTCIceServer[] = [
  {
    urls: 'turn:global.relay.metered.ca:80',
    username: '2560ee1b729bcb1606e21c10',
    credential: 'YcqVJa4nwWfVP2Ro',
  },
  {
